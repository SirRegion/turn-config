# INSTALLS PWSH ON ALPINE LINUX
# From the official Microsoft Documentation:
# https://docs.microsoft.com/de-de/powershell/scripting/install/installing-powershell-core-on-linux?view=powershell-7.1#alpine-39-and-310
